...
export const useActivities = (id?: string) => {
    ...
    const { data: activitiesGroup, isLoading, isFetchingNextPage, fetchNextPage, hasNextPage } = useInfiniteQuery<PagedList<Activity, string>>({      //paritcularly for pagination
    queryKey: ['activities'],
