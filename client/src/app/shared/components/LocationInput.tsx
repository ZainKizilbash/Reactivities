...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.28abe0c259b158cda6506433c72c95b2&limit=5&dedupe=1&';

    const fetchSuggesions = useMemo(
